            ...
            for index in index_list:
                ...
                if i == 3:
                    ...
                    if distancia1 > (1.45*distancia2):
                        cv2.putText(image, 'Giro de cabeza derecha', (100, 45), 1, 1, (0, 255, 255), 2, cv2.LINE_4)
                        break
                    if distancia2 > (1.40*distancia1) :
                        cv2.putText(image, 'Giro de cabeza izquierda', (100, 45), 1, 1, (0, 255, 255), 2, cv2.LINE_4)
                        break

                    if suma1 >= 1.5 * (suma2 / 2):
                        cv2.putText(image, 'Giro de cabeza arriba', (300, 45), 1, 1, (0, 255, 255), 2, cv2.LINE_4)
                        break

                    if (suma2 >= 1.5*suma1):
                        cv2.putText(image, 'Giro de cabeza abajo', (300, 45), 1, 1, (0, 255, 255), 2, cv2.LINE_4)
                        break

                    cv2.putText(image, 'Posicion Correcta', (100, 45), 1, 1, (0, 255, 255), 2, cv2.LINE_4)

                if i != 3:
                    i+=1

    cv2.imshow('Detección de Cabeza', image)
